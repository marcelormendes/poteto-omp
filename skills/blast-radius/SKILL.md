...
6. For a big or wide change, run it as an `arena`. Run the configured native role agents over the same question, collect their results, and synthesize the evidence. Different models catch different real bugs.
