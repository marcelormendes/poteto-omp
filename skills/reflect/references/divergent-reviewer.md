...
- `read` tool calls against any `SKILL.md` file (workspace `.omp/skills/`, user-level `~/.omp/agent/skills/`, or installed package paths)
- Skill invocations (`/skill:name`) that name a skill path
